...
async def main():
    ble_server.start_ble_server_thread(take_picture)  # Start BLE server in a separate thread
    await capture_and_detect(server=None)  # Just to keep the event loop alive for now
